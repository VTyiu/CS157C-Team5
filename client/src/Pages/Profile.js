  ...
  return (
    <div>
      <div className="profile-container">
        ...
        {openMatchForm && (<MatchForm userName={userName} closeMatchForm={setOpenMatchForm}  />)}
        {openUpdateForm && (<UpdateMatchForm userName={userName} closeUpdateForm={setOpenUpdateForm} />)}
      </div>
    </div>
  );
};
